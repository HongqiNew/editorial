...
const LayoutHead = ({ title, cover, description }: LayoutHeadProps) => {
    return (
        <Head>
            ...
            <meta property='og:description' content='《新红旗》，为着无产阶级及其伟大的事业前进！' />
            <meta property='og:type' content='website' />
            <meta property='og:image' content={cover ?? 'https://bbvsukzcbmlmapdkuybx.supabase.co/storage/v1/object/public/bed/card.jpg'} />
        </Head>
    )
}
